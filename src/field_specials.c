...
void randomGrass(void){
	static const u16 sRandomStarter[] = { SPECIES_SEEDOT , SPECIES_ODDISH , SPECIES_BELLSPROUT, SPECIES_TANGELA , SPECIES_EXEGGCUTE  , SPECIES_SUNKERN , SPECIES_HOPPIP , SPECIES_BULBASAUR , SPECIES_CHIKORITA , SPECIES_TREECKO };
//	static const u16 sRivalStarter[] = { SPECIES_PONYTA , SPECIES_GROWLITHE , SPECIES_MAGMAR , SPECIES_VULPIX , SPECIES_NUMEL , SPECIES_SLUGMA , SPECIES_HOUNDOUR , SPECIES_CHARMANDER , SPECIES_CYNDAQUIL , SPECIES_TORCHIC};
	VarSet(VAR_TEMP_2, sRandomStarter[Random() % ARRAY_COUNT(sRandomStarter)]);
	//VarSet(VAR_0x0014, SPECIES_CYNDAQUIL);
}
void randomWater(void){
	static const u16 sRandomStarter[] = { SPECIES_PSYDUCK , SPECIES_GOLDEEN , SPECIES_HORSEA , SPECIES_KRABBY , SPECIES_POLIWAG , SPECIES_OCTILLERY , SPECIES_CHINCHOU , SPECIES_SQUIRTLE , SPECIES_TOTODILE , SPECIES_MUDKIP};
//	static const u16 sRivalStarter[] = { SPECIES_BULBASAUR , SPECIES_ODDISH , SPECIES_BELLSPROUT, SPECIES_TANGELA , SPECIES_EXEGGCUTE , SPECIES_CHIKORITA, SPECIES_SUNKERN, SPECIES_HOPPIP };
	VarSet(VAR_TEMP_2, sRandomStarter[Random() % ARRAY_COUNT(sRandomStarter)]);
	//VarSet(VAR_0x0014, SPECIES_ODDISH);
}
void randomFire(void){
	static const u16 sRandomStarter[] = { SPECIES_CHARMANDER , SPECIES_PONYTA , SPECIES_GROWLITHE , SPECIES_MAGMAR , SPECIES_VULPIX , SPECIES_CYNDAQUIL , SPECIES_SLUGMA , SPECIES_HOUNDOUR , SPECIES_TORCHIC , SPECIES_NUMEL};
//	static const u16 sRivalStarter[] = { SPECIES_SQUIRTLE , SPECIES_GOLDEEN , SPECIES_HORSEA , SPECIES_KRABBY , SPECIES_POLIWAG , SPECIES_TOTODILE , SPECIES_OCTILLERY , SPECIES_CHINCHOU };
	VarSet(VAR_TEMP_2, sRandomStarter[Random() % ARRAY_COUNT(sRandomStarter)]);
	//VarSet(VAR_0x0014, SPECIES_SQUIRTLE);
}
